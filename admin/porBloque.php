...
<html lang="en">
         ...
         <section class="py-5 py-md-6 bg-hero inverse" id="signup" style="background-image: url(img/parallex.jpg)">
            <div class="container">
                 ...
                 <table class="table table-striped table-dark">
                            <thead>
                                <tr>
                                  <th scope="col">CONSULTA POR BLOQUE</th>
                                  <th scope="col"></th>
                                  <th scope="col"></th>
  ...
  <tbody>
    ...
    <?php } ?>
      ...
      <td>
        <div class="form-group">
            <form method="post" action="exportInformePorBloque.php">
