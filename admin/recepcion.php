...
//if(isset($_SESSION['nombre'])) {ESTO ES PARA CERRAR LA SESION 
                            ...
                            <div class="card-body p-4">
                                <form class="signup-form" name="recepcion" id="recepcion" >
                                    <div class="form-group">
                                        <input id = "fechaactual" name = "fechaactual" type="text" class="form-control" value="<?php echo $mesCompleto." sem.".$semana." ".$fechaactual;?>" readonly  size="40" maxlength="30" style="text-transform:uppercase" required >
                                    </div>
                                    <div class="form-group">
                                        <input id = "cod_malla" name = "cod_malla" type="text" placeholder="CODIGO MALLA" class="form-control" value="" autofocus size="6" maxlength="6"  required >
                                    </div>
                                    <input id = "id_finca" type="hidden" name="id_finca" value="1"  >
                                    <div class="form-group">
                                        <input id="pilas" name="codigo_variedad" type="text" class="form-control" placeholder="CODIGO VARIEDAD" size="3"  maxlength="3"  required >
                                    </div>
                                    <div class="form-group">
                                        <input id="numero_tallos" name="numero_tallos" type="text" class="form-control" placeholder="NÚMERO DE TALLOS" size="3" maxlength="3" style="text-transform:uppercase" required>
                                    </div>
                                    
                                    <div class="form-group">
                                        <input id="grado" name="grado" type="text" class="form-control" placeholder="GRADO" size="12" maxlength="12" required>
                                    </div>
                                    <div class="form-group">
                                        <input id="cod_bloque" name="cod_bloque" type="text" class="form-control" placeholder="BLOQUE" size="3" maxlength="3" required>
                                    </div>
                               ...
                               <button type="button" id="empezar" class="btn btn-success btn-block">Reiniciar</button>
...
<?php 
//}else{//ESTO ES PARA EL ACCESO INVALIDO
