...
<html lang="en">
         ...
         <section class="py-5 py-md-6 bg-hero inverse" id="signup" style="background-image: url(img/parallex.jpg)">
            <div class="container">
                 ...
                 <table class="table table-striped table-dark">
                            <thead>
                                <tr>
                                  <th scope="col">POST COSECHA GENERAL</th>
                                  <th scope="col"></th>
                                  <th scope="col"></th>
  ...
  <thead>
    ...
    <tr>
     ...
     <th scope="col">60 CM</th>
     <th scope="col">70 CM</th>
     <th scope="col">80 CM</th>
