...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if(isset($_POST['quien'])) {    //variable para saber si es de produccion o de calidad
        ...
        mysqli_select_db($conexion,$database_conexion);
                ...
                $calcularTotales = "
                  SELECT SUM(`numero_tallos`) AS totalTallosT FROM inventario Join variedad_flor on inventario.codigo_variedad = variedad_flor.codigo_variedad INNER JOIN bloque ON inventario.cod_bloque = bloque.codigo INNER JOIN color ON variedad_flor.id_color = color.id_color and inventario.fecha_calidad BETWEEN '".$fechaDesde."' AND '".$fechaHasta."' AND inventario.codigo_variedad = '".$codigo_variedad."' 
                                               ";
...
<html lang="en">
            ...
            <div class="container">
                ...
                ?>
                 ...
                 <table class="table table-striped table-dark">
                            <thead>
                                <tr>
                                  <th scope="col">CONSULTA POR VARIEDAD</th>
                                  <th scope="col"></th>
                                  <th scope="col"></th>
  ...
  <tbody>
    ...
    <?php } ?>
      ...
      <td>
        <div class="form-group">
            <form method="post" action="exportInformePorVariedad.php">
