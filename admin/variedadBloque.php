...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if(isset($_POST['codigo_variedad'])) {//componente que se almacena en el deposito    
    ...
    if(isset($_POST['quien'])) {    //variable para saber si es de produccion o de calidad
        ...
        mysqli_select_db($conexion,$database_conexion);
                 ...
                 $first = "
                   ...
                   SELECT SUM(`numero_tallos`) AS totalTallos, `cod_bloque`, variedad_flor.nombre, inventario.codigo_variedad, inventario.nombre_mes, inventario.semana, bloque.id_area, variedad_flor.id_variedad, color.color, color.color_spanish, color.code_html FROM inventario Join variedad_flor on inventario.codigo_variedad = variedad_flor.codigo_variedad INNER JOIN bloque ON inventario.cod_bloque = bloque.codigo INNER JOIN color ON variedad_flor.id_color = color.id_color and inventario.fecha_calidad BETWEEN '".$fechaDesde."' AND '".$fechaHasta."' AND inventario.codigo_variedad = '".$codigo_variedad."' AND inventario.cod_bloque = '".$cod_bloque."' GROUP BY inventario.cod_bloque, inventario.codigo_variedad
...
<html lang="en">
    ...
    ?>
         ...
         <section class="py-5 py-md-6 bg-hero inverse" id="signup" style="background-image: url(img/parallex.jpg)">
            <div class="container">
                ...
                <?php //se crea la conexion a la bas de datos
                       mysqli_select_db($conexion,$database_conexion);
                         $consultaVar = "
                
                            SELECT * FROM `variedad_flor` ORDER BY variedad_flor.nombre ASC


                
                ";   

                           $ReConsultaVar =mysqli_query($conexion, $consultaVar);           
                ...
                ?>
                 ...
                 <table class="table table-striped table-dark">
                            <thead>
                                <tr>
                                  <th scope="col">CONSULTA POR VARIEDAD-BLOQUE</th>
                                  <th scope="col"></th>
                                  <th scope="col"></th>
                                  ...
                                  <th scope="row">
                                       <div class="form-group">
                                             ...
                                             <div class="input-group mb-3">
                                                  ...
                                                  <select name = "codigo_variedad" class="custom-select" id="codigo_variedad">
                                                    <option selected>Seleccionar</option>
                                             <?php while($rowVar = mysqli_fetch_array($ReConsultaVar)){
          
                            //primero capturo los datos del usuario y los guardo en variables de arreglo
                            
                                   ?>

                                                    <option value="<?php echo $rowVar['codigo_variedad']; ?>"><?php echo $rowVar['nombre']; ?></option>
                                  ...
                                  <td>
                                    ...
                                    <div class="form-group">
                                             ...
                                             <div class="input-group mb-3">
                                                      <div class="input-group-prepend">
                                                        <label class="input-group-text" for="inputGroupSelect01">Bloque</label>
                                                      </div>
                                                  <select name = "cod_bloque" class="custom-select" id="cod_bloque">
                                                    <option selected>Seleccionar</option>
                                  ...
                                  <th scope="row">
                                      <div class="form-group">
                                              <div class="input-group mb-3">
                                                          ...
                                                          <input class="form-control" type="date" id="fechaHasta" name="fechaDesde">
                                                    </div>
                                              </div></td>
  ...
  <tbody>
    ...
    <?php } ?>
      ...
      <td>
        <div class="form-group">
            <form method="post" action="exportInformePorVariedadBloque.php">
            ...
            <input type="hidden" value="<?php if(isset($_POST['codigo_variedad'])) { echo $_POST['codigo_variedad'];} ?>"  name="codigo_variedad">
            <input type="hidden" value="<?php if(isset($_POST['cod_bloque'])) { echo $_POST['cod_bloque'];} ?>"  name="cod_bloque">
            </form>
        </div>
      </td>
    </tr>
